...
@section('title', 'Tambah Pertemuan - NetLabs Admin')
...
<div class="row">
  <div class="col-md-8 grid-margin stretch-card mx-auto">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Tambah Pertemuan</h4>
        <form action="{{ route('admin.materi.store') }}" method="POST">
          ...
          <div class="mb-3">
            ...
            <textarea name="isi_materi" class="form-control @error('isi_materi') is-invalid @enderror" rows="10" placeholder="Tuliskan isi materi lengkap di sini..." required>{{ old('isi_materi') }}</textarea>
          ...
          <div class="mb-3">
            ...
            <input type="color" name="warna_tema" class="form-control form-control-color @error('warna_tema') is-invalid @enderror" value="{{ old('warna_tema', '#3B82F6') }}">
